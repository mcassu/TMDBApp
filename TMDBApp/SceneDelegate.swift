...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        window?.rootViewController = setupView()
...
extension SceneDelegate{
     ...
     func setupView() -> UITabBarController {
        ...
        tabBarRoot.viewControllers = tabBarList
        
        return tabBarRoot
        
    }
    
    func addNav(_ vc: UIViewController) -> UINavigationController {
        
        let nav = UINavigationController(rootViewController: vc)
        nav.navigationItem.hidesSearchBarWhenScrolling = true
